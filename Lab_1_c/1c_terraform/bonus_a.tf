...
#   armageddon_lab_secret_arn_guess = "arn:aws:secretsmanager:${data.aws_region.armageddon_lab_region01.name}:${data.aws_caller_identity.armageddon_lab_self01.account_id}:secret:${local.armageddon_lab_prefix}/rds/mysql*"
# }
...
#   vpc_id            = aws_vpc.armageddon_lab_vpc01.id
#   service_name      = "com.amazonaws.${data.aws_region.armageddon_lab_region01.name}.s3"
...
#   vpc_id              = aws_vpc.armageddon_lab_vpc01.id
#   service_name        = "com.amazonaws.${data.aws_region.armageddon_lab_region01.name}.ssm"
...
#   vpc_id              = aws_vpc.armageddon_lab_vpc01.id
#   service_name        = "com.amazonaws.${data.aws_region.armageddon_lab_region01.name}.ec2messages"
#   vpc_endpoint_type   = "Interface"
#   private_dns_enabled = true
...
#   vpc_id              = aws_vpc.armageddon_lab_vpc01.id
#   service_name        = "com.amazonaws.${data.aws_region.armageddon_lab_region01.name}.ssmmessages"
#   vpc_endpoint_type   = "Interface"
#   private_dns_enabled = true
...
#   vpc_id              = aws_vpc.armageddon_lab_vpc01.id
#   service_name        = "com.amazonaws.${data.aws_region.armageddon_lab_region01.name}.logs"
#   vpc_endpoint_type   = "Interface"
#   private_dns_enabled = true
...
#   vpc_id              = aws_vpc.armageddon_lab_vpc01.id
#   service_name        = "com.amazonaws.${data.aws_region.armageddon_lab_region01.name}.secretsmanager"
#   vpc_endpoint_type   = "Interface"
#   private_dns_enabled = true
...
#   vpc_id              = aws_vpc.armageddon_lab_vpc01.id
#   service_name        = "com.amazonaws.${data.aws_region.armageddon_lab_region01.name}.kms"
#   vpc_endpoint_type   = "Interface"
#   private_dns_enabled = true
...
#         ]
#         Resource = [
#           "arn:aws:ssm:${data.aws_region.armageddon_lab_region01.name}:${data.aws_caller_identity.armageddon_lab_self01.account_id}:parameter/lab/db/*"
#         ]
#       }
#     ]
#   })
