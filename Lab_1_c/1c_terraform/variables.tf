...
variable "project_name" {
  ...
  type        = string
  default     = "armageddon_lab"
}

variable "vpc_cidr" {
  description = "VPC CIDR (use 10.x.x.x/xx as instructed)."
  type        = string
  default     = "10.155.0.0/16" # TODO: student supplies
}

variable "public_subnet_cidrs" {
  description = "Public subnet CIDRs (use 10.x.x.x/xx)."
  type        = list(string)
  default     = ["10.155.1.0/24", "10.155.2.0/24"] # TODO: student supplies
}

variable "private_subnet_cidrs" {
  description = "Private subnet CIDRs (use 10.x.x.x/xx)."
  type        = list(string)
  default     = ["10.155.101.0/24", "10.155.102.0/24"] # TODO: student supplies
}
...
variable "db_password" {
  ...
  type        = string
  sensitive   = true
  default     = "ArmRDS1426" # TODO: student supplies
}

variable "sns_email_endpoint" {
  description = "Email for SNS subscription (PagerDuty simulation)."
  type        = string
  default     = "kuridango@hotmail.com" # TODO: student supplies
}